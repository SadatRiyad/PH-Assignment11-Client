...
const Banner1 = () => {
    return (
        <div className="card mb-8 mt-8 lg:card-side text-white shadow-xl bg-gradient-to-l from-orange via-amber-300 to-rose-200 mx-4 p-4 pb-4">
            <div className="w-full border pt-4 h-full flex lg:w-2/4 items-center justify-center mt-8">
                <div data-aos="fade-right" data-aos-duration="600" data-aos-anchor-placement="top-bottom" data-aos-delay="500">
                    <figure><img className="rounded-lg" src="https://www.mknspune.com/wp-content/uploads/2020/12/enquiry.png" alt="Banner Image" /></figure>
                </div>
            </div>
            <div className="card-body text-balance w-full lg:w-2/4 justify-center pl-1 lg:pl-8">
                <div data-aos="fade-up" data-aos-duration="600" data-aos-anchor-placement="top-bottom" data-aos-delay="500">
                    <p className="card-title font-normal text-xs text-slate-100 uppercase">BB-QueryHub</p>
                    <h2 className="card-title mt-2 font-bold text-3xl md:text-4xl lg:text-4xl">Unlock the World of Queries...</h2>
                    <p className="text-slate-50 text-sm md:text-lg mt-4">Explore a curated collection of product queries and alternatives on BB-QueryHub. Whether you are searching for better products, unique recommendations, or insights on consumer choices, we have you covered. Our platform connects you with valuable information and user insights to make informed decisions.</p>
                    <div className="card-actions justify-start">
                        <Link to="/allQueries" className="btn w-full bg-orange-500 text-orange border-orange hover:border-orange bg-white hover:bg-white hover:text-orange mt-6 hover:translate-y-1 transition-all duration-100">Explore All Queries</Link>
                    </div>
                </div>
            </div>
        </div>
